...
class Day11Test extends AnyFunSuite {
  ...
  test("Day11 - Part1 - reference") {
    ...
    assertString(
      Day11.parseGrid(input).runSteps(1).toString,
      """6594254334
        |3856965822
        |6375667284
        |7252447257
    ...
    assertString(
      Day11.parseGrid(input).runSteps(2).toString,
      """8807476555
        |5089087054
        |8597889608
        |8485769600
    ...
    assertString(
      Day11.parseGrid(input).runSteps(10).toString,
      """0481112976
        |0031112009
        |0041112504
        |0081111406
